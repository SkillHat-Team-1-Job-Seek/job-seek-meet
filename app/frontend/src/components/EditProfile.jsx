    ...
    return (  
        ...
        <div data-layer="Frame 1686562565" className="Frame1686562565 w-[654.22px] py-8 left-[130px] top-[210px] absolute inline-flex flex-col justify-start items-start gap-9">
          ...
          <div data-layer="Frame 1686562646" className="Frame1686562646 self-stretch h-36 px-12 py-8 relative inline-flex justify-start items-center gap-2.5">
            ...
            <div data-layer="27 years old" className="YearsOld justify-center text-slate-500 text-lg font-semibold font-['Poppins'] leading-normal tracking-wide">27 years old</div>
          </div>
          <div data-layer="Frame 1686562647" className="Frame1686562647 self-stretch h-36 px-12 py-8 relative inline-flex justify-start items-center gap-2.5">
            ...
            <div data-layer="Business Analyst" className="BusinessAnalyst justify-center text-slate-500 text-lg font-semibold font-['Poppins'] leading-normal tracking-wide">Business Analyst </div>
          </div>
          <div data-layer="Frame 1686562560" className="Frame1686562560 self-stretch flex flex-col justify-start items-start gap-3.5">
            <div data-layer="Frame 1686562520" className="Frame1686562520 self-stretch flex flex-col justify-start items-start gap-1.5">
              ...
              <div data-layer="Frame 1852" className="Frame1852 self-stretch h-24 relative">
                ...
                <div data-layer="Toronto, Canada" className="TorontoCanada left-[41px] top-[30.47px] absolute justify-center text-slate-500 text-lg font-semibold font-['Poppins'] leading-normal tracking-wide">Toronto, Canada</div>
              </div>
            </div>
          </div>
          ...
          <div data-layer="John Smith" className="JohnSmith w-28 h-6 left-[39px] top-[135px] absolute justify-center text-slate-500 text-lg font-semibold font-['Poppins'] leading-normal tracking-wide">John Smith</div>
          <div data-layer="Frame 1686562648" className="Frame1686562648 w-[654px] h-80 px-12 py-6 left-0 top-[1144.95px] absolute flex flex-col justify-start items-start gap-2.5">
        ...
        <div data-layer="Frame 1686562601" className="Frame1686562601 w-80 h-[548px] left-[945px] top-[577px] absolute inline-flex flex-col justify-start items-center gap-6">
          <div data-layer="Frame 1686562601" className="Frame1686562601 self-stretch h-80 px-5 py-40 bg-zinc-300 rounded-tr-[32px] rounded-bl-[32px] flex flex-col justify-center items-center gap-2.5">
