...
const Connections = () => {
  const navigate = useNavigate();
    return (  
        <div data-layer="Connections" className="Connections w-[1440px] h-[2401px] relative bg-white overflow-hidden">
        <div data-layer="Connections" className="Connections left-[150px] top-[72px] absolute text-center justify-start text-slate-800 text-5xl font-black font-['Poppins'] leading-[70.20px]">Connections</div>
        <div data-layer="Frame 1686562619" className="Frame1686562619 w-[1150px] left-[144px] top-[191px] absolute bg-teal-500/5 inline-flex justify-start items-center gap-24">
          <div data-layer="Frame 1686562612" className="Frame1686562612 w-80 h-16 px-5 py-3 opacity-50 bg-gray-200 rounded-2xl flex justify-center items-center gap-4">
            <div data-layer="Search" className="Search flex-1 justify-center text-slate-800/50 text-2xl font-bold font-['Poppins'] leading-7 tracking-wide">Search</div>
          </div>
          <div data-layer="Frame 1686562614" className="Frame1686562614 w-56 h-16 px-5 py-3 opacity-50 bg-gray-200 rounded-2xl flex justify-center items-center gap-4">
            <div data-layer="Industry" className="Industry flex-1 justify-center text-slate-800 text-2xl font-bold font-['Poppins'] leading-7 tracking-wide">Industry</div>
            <div data-svg-wrapper data-layer="Vector" className="Vector">
              <svg width="26" height="16" viewBox="0 0 26 16" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path fill-rule="evenodd" clip-rule="evenodd" d="M3.25 0L13 9.6L22.75 0L26 3.2L13 16L0 3.2L3.25 0Z" fill="#4E4B66"/>
              </svg>
            </div>
          </div>
          <div data-layer="Frame 1686562613" className="Frame1686562613 w-96 h-16 px-5 py-3 opacity-50 bg-gray-200 rounded-2xl flex justify-center items-center gap-4">
            <div data-layer="Invite New Connection" className="InviteNewConnection flex-1 text-center justify-center text-slate-800 text-2xl font-bold font-['Poppins'] leading-7 tracking-wide">Invite New Connection</div>
          </div>
        </div>
        <div data-layer="Frame 1686562621" className="Frame1686562621 w-48 p-2.5 left-[631px] top-[1964px] absolute bg-slate-50 inline-flex flex-col justify-start items-start gap-2.5">
          <div data-layer="Stepper - Increment" data-number="False" data-orientation="Horizontal" className="StepperIncrement self-stretch inline-flex justify-start items-center gap-5">
            <div data-layer="🚧 Builder - Increment Inputs" data-action="Remove" data-state="Default" className="BuilderIncrementInputs size-20 bg-neutral-50 rounded-[53.62px] inline-flex flex-col justify-center items-center gap-6 overflow-hidden">
              <div data-svg-wrapper data-layer="Minus" className="Minus relative">
                <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M4.03125 15L25.9687 15" stroke="#14142B" stroke-width="4.875" stroke-linecap="round" stroke-linejoin="round"/>
                </svg>
              </div>
            </div>
            <div data-layer="🚧 Builder - Increment Inputs" data-action="Add" data-state="Default" className="BuilderIncrementInputs size-20 bg-neutral-50 rounded-[53.62px] inline-flex flex-col justify-center items-center gap-14 overflow-hidden">
              <div data-svg-wrapper data-layer="Plus" className="Plus relative">
                <svg width="31" height="30" viewBox="0 0 31 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M15.5 4.03125V25.9688M4.53125 15H26.4688" stroke="#14142B" stroke-width="4.875" stroke-linecap="round" stroke-linejoin="round"/>
                </svg>
              </div>
            </div>
          </div>
        </div>
        <div data-layer="Frame 1686562617" className="Frame1686562617 size- left-[1065px] top-[309px] absolute inline-flex justify-start items-center gap-2">
          <div data-svg-wrapper data-layer="Ellipse 29" className="Ellipse29">
            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
            <circle cx="8" cy="8" r="8" fill="#008A00"/>
            </svg>
          </div>
          <div data-layer="Active / Inactive" className="ActiveInactive justify-start text-black text-base font-semibold font-['Poppins'] leading-tight tracking-wide">Active / Inactive</div>
        ...
        <div data-layer="Frame 1686562620" className="Frame1686562620 w-[1147px] h-[1557.60px] left-[150px] top-[383px] absolute bg-teal-500/5 rounded-[32px] outline outline-2 outline-offset-[-2px] outline-cyan-950">
          <div data-layer="Frame 1686562610" className="Frame1686562610 w-[1147px] px-4 left-0 top-0 absolute inline-flex justify-between items-center">
            <div data-layer="Frame 1686562596" className="Frame1686562596 size- flex justify-start items-center">
              <div data-layer="Frame 1686562629" className="Frame1686562629 size-24 px-0.5 py-2.5 rounded-[50px] flex justify-end items-end gap-2.5">
                <div data-svg-wrapper data-layer="Ellipse 36" className="Ellipse36">
                  <svg width="16" height="17" viewBox="0 0 16 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <circle cx="8" cy="8.80078" r="8" fill="#008A00"/>
                  </svg>
                </div>
              </div>
              <div data-layer="Frame 166" className="Frame166 size- px-8 py-4 inline-flex flex-col justify-start items-start overflow-hidden">
                <div data-layer="John Smith" className="JohnSmith justify-center text-gray-600 text-3xl font-semibold font-['Poppins'] leading-[63.20px] tracking-wide">John Smith</div>
                <div data-layer="Meta" className="Meta justify-center text-slate-400 text-3xl font-medium font-['Poppins'] leading-[63.20px] tracking-wide">Software  Engineer </div>
                <div data-layer="Meta" className="Meta justify-center text-slate-400 text-3xl font-medium font-['Poppins'] leading-[63.20px] tracking-wide">Collaborating on projects </div>
              </div>
            </div>
            <div data-layer="Button - Secondary" className="ButtonSecondary size- flex justify-start items-start">
              <div data-layer="Button - Secondary" data-icon-placement="No Icon" data-size="Large" data-state="Default" className="ButtonSecondary w-44 px-8 py-4 rounded-xl outline outline-2 outline-offset-[-2px] outline-cyan-950 flex justify-center items-center gap-4">
                <div data-layer="Button" className="Button text-center justify-center text-cyan-950 text-lg font-semibold font-['Poppins'] leading-loose tracking-wide">Message</div>
              </div>
            </div>
          </div>
          <div data-layer="Frame 1686562611" className="Frame1686562611 w-[1147px] px-4 left-0 top-[260px] absolute inline-flex justify-between items-center">
            <div data-layer="Frame 1686562596" className="Frame1686562596 size- flex justify-start items-center">
              <div data-layer="Frame 1686562630" className="Frame1686562630 size-24 px-[5px] py-2.5 rounded-[50px] flex justify-end items-end gap-2.5">
                <div data-svg-wrapper data-layer="Ellipse 35" className="Ellipse35">
                  <svg width="16" height="17" viewBox="0 0 16 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <circle cx="8" cy="8.80078" r="8" fill="#008A00"/>
                  </svg>
                </div>
              ...
              <div data-layer="Frame 166" className="Frame166 size- px-8 py-4 inline-flex flex-col justify-start items-start overflow-hidden">
                <div data-layer="Esther Howard" className="EstherHoward justify-center text-gray-600 text-3xl font-semibold font-['Poppins'] leading-[63.20px] tracking-wide">Esther Howard</div>
                <div data-layer="Meta" className="Meta justify-center text-slate-400 text-3xl font-medium font-['Poppins'] leading-[63.20px] tracking-wide">Marketing Specialist </div>
                <div data-layer="Meta" className="Meta justify-center text-slate-400 text-3xl font-medium font-['Poppins'] leading-[63.20px] tracking-wide">Looking for internships </div>
              </div>
            </div>
            <div data-layer="Button - Secondary" className="ButtonSecondary size- flex justify-start items-start">
              <div data-layer="Button - Secondary" data-icon-placement="No Icon" data-size="Large" data-state="Default" className="ButtonSecondary w-44 px-8 py-4 rounded-xl outline outline-2 outline-offset-[-2px] outline-cyan-950 flex justify-center items-center gap-4">
          ...
          <div data-layer="Frame 1686562606" className="Frame1686562606 w-[1147px] px-4 left-0 top-[520px] absolute inline-flex justify-between items-center">
            <div data-layer="Frame 1686562596" className="Frame1686562596 size- flex justify-start items-center">
              <img data-layer="Ellipse 101" className="Ellipse101 size-24 rounded-full" src="https://placehold.co/100x100" />
              <div data-layer="Frame 166" className="Frame166 size- px-8 py-4 inline-flex flex-col justify-start items-start overflow-hidden">
                <div data-layer="Jacob Jones" className="JacobJones justify-center text-gray-600 text-3xl font-semibold font-['Poppins'] leading-[63.20px] tracking-wide">Jacob Jones</div>
                <div data-layer="Meta" className="Meta justify-center text-slate-400 text-3xl font-medium font-['Poppins'] leading-[63.20px] tracking-wide">Product Designer </div>
                <div data-layer="Meta" className="Meta justify-center text-slate-400 text-3xl font-medium font-['Poppins'] leading-[63.20px] tracking-wide">Open to mentorship </div>
              </div>
            </div>
            <div data-layer="Button - Secondary" className="ButtonSecondary size- flex justify-start items-start">
              <div data-layer="Button - Secondary" data-icon-placement="No Icon" data-size="Large" data-state="Default" className="ButtonSecondary w-44 px-8 py-4 rounded-xl outline outline-2 outline-offset-[-2px] outline-cyan-950 flex justify-center items-center gap-4">
          ...
          <div data-layer="Frame 1686562612" className="Frame1686562612 w-[1147px] px-4 left-0 top-[780px] absolute inline-flex justify-between items-center">
            <div data-layer="Frame 1686562596" className="Frame1686562596 size- flex justify-start items-center">
              <div data-layer="Frame 1686562630" className="Frame1686562630 size-24 px-[5px] py-2.5 rounded-[50px] flex justify-end items-end gap-2.5">
                <div data-svg-wrapper data-layer="Ellipse 37" className="Ellipse37">
                  <svg width="16" height="17" viewBox="0 0 16 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <circle cx="8" cy="8.80078" r="8" fill="#008A00"/>
                  </svg>
                </div>
              ...
              <div data-layer="Frame 166" className="Frame166 size- px-8 py-4 inline-flex flex-col justify-start items-start overflow-hidden">
                <div data-layer="Lovelyn Mars" className="LovelynMars justify-center text-gray-600 text-3xl font-semibold font-['Poppins'] leading-[63.20px] tracking-wide">Lovelyn Mars</div>
                <div data-layer="Meta" className="Meta justify-center text-slate-400 text-3xl font-medium font-['Poppins'] leading-[63.20px] tracking-wide">Data Analyst</div>
                <div data-layer="Meta" className="Meta justify-center text-slate-400 text-3xl font-medium font-['Poppins'] leading-[63.20px] tracking-wide">Open to mentorship</div>
              </div>
            </div>
            <div data-layer="Button - Secondary" className="ButtonSecondary size- flex justify-start items-start">
          ...
          <div data-layer="Frame 1686562613" className="Frame1686562613 w-[1147px] px-4 left-0 top-[1040px] absolute inline-flex justify-between items-center">
            <div data-layer="Frame 1686562596" className="Frame1686562596 size- flex justify-start items-center">
              <div data-layer="Frame 1686562631" className="Frame1686562631 size-24 px-[5px] py-2.5 rounded-[50px] flex justify-end items-end gap-2.5">
                <div data-svg-wrapper data-layer="Ellipse 38" className="Ellipse38">
                  <svg width="16" height="17" viewBox="0 0 16 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <circle cx="8" cy="8.80078" r="8" fill="#008A00"/>
                  </svg>
                </div>
              ...
              <div data-layer="Frame 166" className="Frame166 size- px-8 py-4 inline-flex flex-col justify-start items-start overflow-hidden">
                <div data-layer="Kelvin Hunt" className="KelvinHunt justify-center text-gray-600 text-3xl font-semibold font-['Poppins'] leading-[63.20px] tracking-wide">Kelvin Hunt</div>
                <div data-layer="Meta" className="Meta justify-center text-slate-400 text-3xl font-medium font-['Poppins'] leading-[63.20px] tracking-wide">Software  Engineer </div>
                <div data-layer="Meta" className="Meta justify-center text-slate-400 text-3xl font-medium font-['Poppins'] leading-[63.20px] tracking-wide">Looking for internships</div>
              </div>
            </div>
          ...
          <div data-layer="Frame 1686562607" className="Frame1686562607 w-[1147px] px-4 left-0 top-[1300px] absolute inline-flex justify-between items-center">
            <div data-layer="Frame 1686562596" className="Frame1686562596 size- flex justify-start items-center">
              <img data-layer="Ellipse 101" className="Ellipse101 size-24 rounded-full" src="https://placehold.co/100x100" />
              <div data-layer="Frame 166" className="Frame166 size- px-8 py-4 inline-flex flex-col justify-start items-start overflow-hidden">
                <div data-layer="Bianca Hugs" className="BiancaHugs justify-center text-gray-600 text-3xl font-semibold font-['Poppins'] leading-[63.20px] tracking-wide">Bianca Hugs</div>
                <div data-layer="Meta" className="Meta justify-center text-slate-400 text-3xl font-medium font-['Poppins'] leading-[63.20px] tracking-wide">Web Developer</div>
                <div data-layer="Meta" className="Meta justify-center text-slate-400 text-3xl font-medium font-['Poppins'] leading-[63.20px] tracking-wide">Collaborating on projects</div>
              </div>
            </div>
            <div data-layer="Button - Secondary" className="ButtonSecondary size- flex justify-start items-start">
