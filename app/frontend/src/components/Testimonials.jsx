...
const Testimonials = () => {
  return (
    <div data-layer="Frame 1686562482" className="Frame1686562482 w-[1440px] px-28 py-10 relative bg-black/60 inline-flex flex-col justify-start items-start gap-2.5">
        ...
        <div data-layer="Frame 1686562509" className="Frame1686562509 self-stretch flex flex-col justify-start items-start gap-2">
          ...
          <div data-layer="wrapper" className="Wrapper self-stretch h-96 relative overflow-hidden">
            <div data-layer="card" className="Card w-[560px] max-w-[560px] min-w-[552px] p-4 left-0 top-[6px] absolute bg-gray-200 rounded-tr-[32px] rounded-bl-[32px] inline-flex justify-start items-start gap-4 overflow-hidden">
              <img data-layer="photoWrapper" className="Photowrapper size-16 relative rounded-[60px]" src="https://placehold.co/64x64" />
            ...
            <div data-layer="card" className="Card w-[560px] max-w-[560px] min-w-[552px] p-4 left-[326px] top-[210px] absolute bg-gray-200 rounded-tr-[32px] rounded-bl-[32px] inline-flex justify-start items-start gap-4 overflow-hidden">
              <img data-layer="photoWrapper" className="Photowrapper size-16 relative rounded-[60px]" src="/assets/" />
              <div data-layer="info_wrapper" className="InfoWrapper flex-1 pt-1.5 inline-flex flex-col justify-center items-start gap-1 overflow-hidden">
