...
# It uses Pydantic BaseSettings to load environment variables and validate them.
...
#   are not left as default values ("change this") in production environments.
# - Using Pydantic model_validator to validate settings after initialization.
